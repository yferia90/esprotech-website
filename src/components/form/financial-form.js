                    ...
                    <Formik
                        ...
                        onSubmit={async (values) => {
                            ...
                            if (newMonto !== null) {
                                ...
                                if (type === enumOperations.ahorro) setMontoAhorro(newMonto);
                                if (type === enumOperations.inversion) setMontoInversion(newMonto);
                                if (type === enumOperations.gasto) setMontoGasto(newMonto);
                                if (type === enumOperations.deuda) setMontoDeuda(newMonto);
                            } else {
